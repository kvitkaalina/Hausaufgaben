...
const arrayEl = [1, 2, 3, 4, 5, 6, 7, 8];

function trueFalse(arr) {
  arr.forEach(value => {
    if (value % 2 == 0) {
      console.log('Четные: ' + value);
    } else {
      console.log('Нечетные: ' + value);
    }
  });
}
...
const numbers8 = [1, 2, 5, 6, 7]
function numbersNew(arr) {
  const numbersF = ((arr) => arr * arr) 
  return numbersF
  console.log(numbersNew(numbers8));
